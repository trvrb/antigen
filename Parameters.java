...
public class Parameters {
	...
	public static final int endDay = 20*365; // 10950
	...
	public static final double yearsFromMK = 5;							// subtract this many years off the end of the simulation when doing MK test
